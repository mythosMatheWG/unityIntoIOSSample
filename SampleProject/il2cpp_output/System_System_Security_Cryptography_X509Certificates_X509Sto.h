...
struct  X509Store_t463  : public Object_t
{
	...
	X509Certificate2Collection_t454 * ___list_2;
	...
	X509Store_t477 * ___store_4;
};
struct X509Store_t463_StaticFields{
	...
	Dictionary_2_t78 * ___U3CU3Ef__switchU24mapF_5;
};
